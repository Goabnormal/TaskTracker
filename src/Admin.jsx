...
const Admin = ({ username, setUser, user, designation, mailid }) => {
  ...
  const fetchEmployeeIds = async () => {
    try {
      const response = await fetch(
        "https://script.google.com/macros/s/AKfycby3wjFpNKtYqHi-CHA-kOx7GNdS_iCm4SpFE2-1AO-X02dDDHF-DxPdp3sVcARjWsSKYQ/exec?mode=dropdown"
      );
  ...
  const fetchEmployeeData = async (employeeId) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://script.google.com/macros/s/AKfycby3wjFpNKtYqHi-CHA-kOx7GNdS_iCm4SpFE2-1AO-X02dDDHF-DxPdp3sVcARjWsSKYQ/exec?employeeId=${employeeId}`
      );
      const data = await response.json();
  ...
  const fetchEmployeeAllData = async () => {
    ...
    try {
      ...
      // setSelectedEmployee(employeeId);
      const response = await fetch(
        `https://script.google.com/macros/s/AKfycby3wjFpNKtYqHi-CHA-kOx7GNdS_iCm4SpFE2-1AO-X02dDDHF-DxPdp3sVcARjWsSKYQ/exec?mode=allTasks`
      );
      const data = await response.json();
